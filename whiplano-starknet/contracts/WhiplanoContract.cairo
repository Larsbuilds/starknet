...
mod WhiplanoContract {
    ...
    #[external(v0)]
    fn update_user_limit(ref self: ContractState, new_limit: u32) {
        let caller = get_caller_address();
    ...
    #[view]
    fn is_user_allowed(self: @ContractState, user: ContractAddress) -> bool {
    ...
    #[view]
    fn get_max_users(self: @ContractState) -> u32 {
        self.max_users.read()
    }

    #[view]
    fn is_limited(self: @ContractState) -> bool {
