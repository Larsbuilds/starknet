...
mod tests {
    ...
    fn test_bitmap_operations() {
        ...
        assert(!WhiplanoContract::is_user_allowed(@state, user), 'User should not be in bitmap initially');
        ...
        assert(WhiplanoContract::is_user_allowed(@state, user), 'User should be in bitmap after addition');
    }
} 